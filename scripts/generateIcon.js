// 生成应用图标 build/icon.png（1024×1024）：紫白配色、居中白色方形、
// 方形内部右下角紫色圆点（水印位置意象）。
...
<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- 居中白色方形 -->
  <rect x="232" y="232" width="560" height="560" rx="128" fill="url(#card)" filter="url(#soft)"/>
  <!-- 卡内细描边 -->
  <rect x="268" y="268" width="488" height="488" rx="100" fill="none" stroke="#8b5cf6" stroke-opacity="0.15" stroke-width="8"/>

  <!-- 方形内部右下角紫色圆点（水印位置） -->
  <circle cx="716" cy="716" r="56" fill="url(#dot)" filter="url(#soft-sm)"/>
  <circle cx="716" cy="716" r="56" fill="none" stroke="#ffffff" stroke-opacity="0.55" stroke-width="6"/>
</svg>`
